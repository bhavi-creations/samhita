...
<div class="container-fluid mt-4">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form action="<?= base_url('gst-rates/update/' . $gstRate['id']) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control <?= (session()->getFlashdata('errors.name')) ? 'is-invalid' : '' ?>" value="<?= old('name', $gstRate['name']) ?>" required>
