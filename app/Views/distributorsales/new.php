    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <?php if (session('validation') && session('validation')->hasError('discount_amount')): // Changed 'discount' to 'discount_amount' ?>
                    <div class="text-danger mt-1">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="payment_method" name="payment_type">
                    ...
                    <?php foreach ($paymentMethods as $key => $method): ?>
                        <option value="<?= esc($key) ?>" <?= set_select('payment_type', $key) ?>>
                            <?= esc($method) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Changed this line to point to the correct name for consistency, though ID is used for JS
    ...
    function updateOverallTotals() {
        ...
        // The ID is 'discount' so this line is fine for JS
    ...
    // Discount input listener (moved here)
